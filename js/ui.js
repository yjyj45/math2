      ...
      <div class="panel${fb}" style="--panel-bg:${theme.bg}">
        ...
        <div class="keypad ${panel.locked ? 'disabled' : ''}">
          <div class="keypad-tabs">
            <button class="tab whole-tab ${panel.activeField === 'whole' ? 'active' : ''}" data-action="select-field" data-panel="${panel.id}" data-field="whole">${fieldContent(panel.inputs.whole, '자연수')}</button>
            <div class="fraction-tab">
